...
class AddCard extends React.Component {
    ...
    sbmtCard = (title, question) => {
        ...
        if (question === '' || (answer[0] === '')) {
            ...
            try {
                ...
                // reset form
                this.setState({question: '', answer: [], note: '', noteNumber: [], para: []});
                ...
                // console.log("CLICKED ZCDDsw")   	// go back to Deck 	  Keyboard.dismiss();
    ...
    render() {
        ...
        const {title} = this.props.navigation.state.params.deck
            ...
            : this.props.navigation.state.params.deckData.title;
        return (
                                ...
                                .map((value, index) => (
                                    <View>
                                        <Input
                                            ...
                                            multiline={false}
                                            maxLength={100}
                                            ref={input => this[`aInput${index}`] = input}
                                            onChangeText={this.handleAnswer(index)}/>
                                        <Text style={styles.index}>{value.note.length}/100
                                        </Text>
                                    </View>
                                ))}
                            {this
                                    ...
                                    <View style={styles.container}>
                                        <View style={styles.textAreaContainer}>
                                            ...
                                            <TextInput
                                                ...
                                                maxLength={500}
                                                ref={input => this[`aInput${index}`] = input}
                                                onChangeText={this.handlePara(index)}/>
                                        </View>
